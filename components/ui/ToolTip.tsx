      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={cn(
              "pointer-events-none absolute z-50 whitespace-nowrap rounded-lg border border-white/10 bg-neutral-900/40 px-2 py-1 text-sm text-neutral-200 shadow-xl shadow-black/20 backdrop-blur-2xl",
              config.className,
              className,
            )}
          >
