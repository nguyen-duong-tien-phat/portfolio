...
export default function Projects() {
  ...
  const NameComp = projectsConfig[activeProject].nameComp;
  ...
  return (
    <Section name="projects" className="grid grid-cols-1 lg:grid-cols-5">
      <div data-scrollable className="col-span-3 overflow-hidden">
      ...
      <div className="col-span-2 pt-5 lg:pt-28 lg:pb-30 lg:pl-5 flex flex-col lg:justify-center">
        <div className="flex items-center mb-2">
          <Image
            alt="logo"
            src={projectsConfig[activeProject].logo}
            width={50}
            height={50}
          />
          <div className="flex-1 ml-3">
            {NameComp ? (
              ...
              <h3 className="text-5xl">{projectsConfig[activeProject].name}</h3>
            )}
          </div>

          <a
            href={projectsConfig[activeProject].github}
            className="ml-7 text-black hover:text-blue-700"
          >
            <Github className="w-8" />
          </a>
          <a
            href={projectsConfig[activeProject].link}
        ...
        <p className="flex-1 mt-5 font-mono md:text-lg text-justify">
          {projectsConfig[activeProject].desc}
        </p>
        ...
        <div className="flex justify-center gap-5">
          ...
          <Button
            icon
            onClick={nextProject}
            disabled={activeProject === projectsConfig.length}
          >
